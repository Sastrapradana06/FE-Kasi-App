        ...
        data.map((item, i) => (
          <tbody key={i} >
            <tr>
              ...
              <td className="p-2 border text-start border-gray-300">{item.quantity.toLocaleString()}</td>
              ...
              <td className="p-2 border text-center border-gray-300">{item.keterangan}</td>
