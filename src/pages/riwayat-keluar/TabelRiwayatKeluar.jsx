...
TabelRiwayatKeluar.propTypes = {
  data: PropTypes.arrayOf(PropTypes.object).isRequired,
  edit: PropTypes.func.isRequired,
  deleteRiwayat: PropTypes.func.isRequired,
};

export default function TabelRiwayatKeluar({ data, edit, deleteRiwayat }) {
  ...
  return (
    <table className="border w-[100%] h-max " >
      ...
      {data.length > 0 ? (
        ...
        <tbody>
          <tr>
            <td colSpan={8}  className=" text-[crimson] p-1 text-center border-gray-300">Data Riwayat Keluar Kosong</td>
          </tr>
        </tbody>
      )}
    </table>
